...
public abstract class UserDtoData {
	...
	public static List<UserDto> dataForGlobalCommentControllerTest() {
		...
		users.add(UserDtoInstantiator.createUser("teste16", "teste16", "teste11@gmail.com", "123"));
		users.add(UserDtoInstantiator.createUser("teste17", "teste17", "teste12@gmail.com", "123"));
		users.add(UserDtoInstantiator.createUser("teste18", "teste18", "teste13@gmail.com", "123"));
		users.add(UserDtoInstantiator.createUser("teste19", "teste19", "teste14@gmail.com", "123"));
		users.add(UserDtoInstantiator.createUser("teste20", "teste20", "teste15@gmail.com", "123"));

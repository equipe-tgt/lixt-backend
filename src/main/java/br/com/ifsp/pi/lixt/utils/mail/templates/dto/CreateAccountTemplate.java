	...
	public static MailDto getTemplate() {
		...
		return MailDto.builder()
				...
				.msgHTML("<!DOCTYPE html>\r\n" + 
						...
						"\r\n" + 
						"            <div class=\"header\">\r\n" + 
						"                <h1><center>Bem-Vindo à Plataforma Lixt</center></h1>\r\n" + 
						"            </div>\r\n" + 
						"\r\n" + 
						"            <div class=\"body\">\r\n" + 
						"                <p class=\"greeting\">Olá, $USERNAME!</p>\r\n" + 
						"                <p>Ficamos felizes em te receber no Lixt!</p>\r\n" + 
						"\r\n" + 
						"                <a href=\"$BASE_URL/auth/active-user?token=$TOKEN\">\r\n" + 
						"                    <p>Antes de realizar seu primeiro acesso, clique aqui para ativar a conta</p>\r\n" + 
						"                </a>\r\n" + 
						"            </div>\r\n" + 
						"\r\n" + 
						"            <div class=\"footer\">\r\n" + 
